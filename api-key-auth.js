    ...
    setupFireBuildAIKeys() {
        ...
        const firebuildKeys = {
            ...
            production: {
                ...
                permissions: ['estimates', 'carpentry', 'electrical', 'plumbing', 'painting', 'compliance', 'orchestration', 'health', 'tasks'],
            ...
            demo: {
                ...
                permissions: ['estimates', 'health', 'carpentry', 'electrical', 'plumbing', 'painting', 'compliance', 'orchestration', 'tasks'],
